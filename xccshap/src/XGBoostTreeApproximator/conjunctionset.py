...
from XGBoostTreeApproximator.TreesExtraction import *
from collections import Counter
from XGBoostTreeApproximator.pruning import *
...
class ConjunctionSet():
    ...
    def __init__(self, max_number_of_conjunctions=np.inf, filter_method='probability'):
        ...
        :param filter_method: The approach thapipt will be takes for filtering conjunctions
        """
