...
def ccshap_full(id_dataset, output_path, model_path, max_depth=100, model_type = XGBClassifier()):
   ...
   for target_col in df_y.columns:
      ...
      for rnd in range(10):
         ...
         pkl_file_name = "fbtrf_model_"+dataset_name.replace(" ", "_")+"_"+target_col.replace(" ", "_")+"_"+str(rnd)+".pkl"
      ...
      output_file_name = "xccshap_var_fbtrf_"+dataset_name.replace(" ", "_")+"_"+target_col.replace(" ", "_")+".csv"
